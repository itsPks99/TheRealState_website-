    ...
    <div className="features-container">
      ...
      <div className="features-content">
        <div className="features-image slide-left">
          <img src="../src/assets/537011899.jpg" alt="Luxury Homes" />
        </div>
      ...
      <div className="features-icons slide-bottom">
        <div className="icon-box highlight">
          <img src="../src/assets/Homeicon.png" alt="Auramah Valley" />
          <h3>AURAMAH VALLEY</h3>
          <p>India's #1 Hillside Community</p>
        </div>
        <div className="icon-box highlight">
          <img src="../src/assets/LocationIcon.png" alt="Location" />
          <h3>THE LOCATION</h3>
          <p>Naldehra, Shimla</p>
        </div>
        <div className="icon-box">
          <img src="../src/assets/AreaIcon.png" alt="Area" />
          <h3>THE AREA</h3>
          <p>1500 SQ. FT. - 2150 SQ. FT.</p>
        </div>
        <div className="icon-box">
          <img src="../src/assets/PricingIcon.png" alt="Pricing" />
          <h3>THE PRICING</h3>
