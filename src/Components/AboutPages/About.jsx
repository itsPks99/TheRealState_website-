    ...
    <div className="about-container">
      <section id="about-our-company" className="section split-background">
        ...
        <div className="content">
          ...
          <p>Welcome to Yoglyf Wellness Resort, a pioneering leader in the realm of
            hospitality and wellness projects. Here, we merge expertise in hospitality
            with a deep commitment to enhancing wellness, ensuring that every
            project we undertake sets a new standard for excellence, luxury, comfort
            and care. We follow a set of core values that are based on the four
            pillars listed below:</p>
          <ul>
            <li><strong>Integrity:</strong>Integrity: Upholding the highest ethical standards and transparency in all our interactions.</li>
            <li><strong>Innovation:</strong> Innovation: Embracing cutting-edge technologies and design principles to deliver state-of-the-art wellness facilities.</li>
            <li><strong>Compassion:</strong> Compassion: Centering our projects around empathy and understanding, ensuring patient-centered care remains paramount.</li>
            <li><strong>Excellence:</strong> Excellence: Committing to excellence in every facet of our projects,from initial concept to ongoing operational management.</li>
          </ul>
        </div>
      ...
      <section id="our-vision" className="section split-background">
        ...
        <div className="content">
          <h2>Our Vision</h2>
          <h3>The Future of Real Estate: Technology and Innovation</h3>
          <h4>BUILD NEW SYSTEM</h4>
          <p>Driven by a vision of transformative impact, Yoglyf strives to
            be at the forefront of integrating holistic healing with
            prosperity. We envision spaces that blend advanced
            wellness technologies with thoughtful design, fostering
            holistic health and sustainable living.
            Our futuristic approach envisages creating an impact that
            elevates lifestyles as well as delivering significant value to
            our investors, by means of exquisite opportunity; blending
            opulence with advancement, ensuring a transformative
            impact on both, residents and stakeholders.</p>
        </div>
      </section>
      ...
      <section id="our-mission" className="section split-background">
        <div className="content">
          ...
          <h3>The Future of Real Estate: Technology and Innovation</h3>
          <h4>BUILD NEW SYSTEM</h4>
          <p>At Yoglyf Wellness Resort, our mission is to redefine the
            luxury and wellness experience through innovative
            hospitality solutions. We aim to create environments that
            not only meet wellness needs but also nurture healing,
            comfort, and community well-being.
            We work to deliver unparalleled luxury living experiences
            that blend elegance with comprehensive wellness
            amenities; whilst prioritizing quality, innovation, and
            investor opportunity with satisfaction. Keeping this in
            mind, our company continues the search for discerning
            individuals seeking luxury alongside Wellness Retreat,
